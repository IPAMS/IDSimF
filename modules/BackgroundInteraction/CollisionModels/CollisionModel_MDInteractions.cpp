            ...
            for(auto* atomI : moleculesPtr.at(i)->getAtoms()){
                for(auto* atomJ : moleculesPtr.at(j)->getAtoms()){
                    ...
                    if(distance.magnitude() < 1E-25){
                        forceMolecules.at(i) += Core::Vector(1e-15, 1e-15, 1e-15);
                        forceMolecules.at(j) += Core::Vector(1e-15, 1e-15, 1e-15) * (-1);
                        break;
                    }
                    ...
                    //std::cout << "LJ: " << distance.x() * ljFactor << std::endl;
                    ...
                    //std::cout << "Atom: " << atomForce << std::endl;
                    ...
                    if(moleculesPtr.at(i)->getIsIon() == true && 
                        ...
                        // std::cout << "Charge1: " << currentCharge << std::endl;
                        ...
                        // std::cout << "Charge2: " << currentCharge << std::endl;
                    }
                    
                    // std::cout << "----" << std::endl;
                    // std::cout << eField[0] << "\n" << eField[1] << "\n" << eField[2] << std::endl;
                    // std::cout << eFieldDerivative[0] << "\n" << eFieldDerivative[1] << "\n" << eFieldDerivative[2] << std::endl;
                    // std::cout << eFieldDerivative[3] << "\n" << eFieldDerivative[4] << "\n" << eFieldDerivative[5] << std::endl;
                    // std::cout << currentCharge << " " << distance.x() << " " << distance.z() << " " <<  (distanceCubed * distanceSquared) << std::endl; 
                    // std::cout << "----" << std::endl;
                    ...
                    // std::cout << "Efield: " << distance.x() * currentCharge / distanceCubed << std::endl;
                    ...
                    //std::cout << "Dipole: " << ionDipoleForce << std::endl;
                }
            }

            // add the C4 ion induced force
            Core::Vector ionInducedForce;
            // std::cout << "Constants: " <<1/Core::ELECTRIC_CONSTANT * collisionGasPolarizability_m3_ << " term: " << 
                                // (eField[0]*eFieldDerivative[0] + eField[1]*eFieldDerivative[1] + eField[2]*eFieldDerivative[5]) << std::endl;
