...
TEST_CASE("Test HDF5 file reading", "[ParticleSimulation][file reader][file reader]") {
    ...
    FileIO::HDF5File h5reader_trajectory("test_particle_trajectory.h5");
    FileIO::HDF5File h5reader_scalarField("test_linear_scalar_field_01.h5");

    SECTION("Testing of attribute reading") {
        SECTION("Hdf5 file can read string attribute vector") {
        ...
        SECTION("Hdf5 file can read integer attribute vector") {
        ...
        SECTION("Hdf5 file can read double attribute vector") {
    ...
    SECTION("Data sets with double type are readable"){
        ...
        SECTION("Read times vector from particle trajectory"){
            FileIO::HDF5File::DataField dFieldTimes = h5reader_trajectory.readDataset<1>(
        ...
        SECTION("Read particle simulation frame from particle trajectory"){
            FileIO::HDF5File::DataField auxParams =
            ...
            FileIO::HDF5File::DataField positions =
        ...
        SECTION("Read scalar field data set"){
            FileIO::HDF5File::DataField scalarField =
        ...
        SECTION("Read small vector field data set"){
            FileIO::HDF5File h5reader_vectorField("test_linear_vector_field_01.h5");

            FileIO::HDF5File::DataField vecField_1 =
                    h5reader_vectorField.readDataset<4>("fields/test_vectorfield_1");

            FileIO::HDF5File::DataField vecField_2 =
        ...
        SECTION("Read large vector field file") {
            FileIO::HDF5File h5reader_flow("quad_dev_flow_3d.h5");
