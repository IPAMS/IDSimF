/***************************
 ...
 Testing of parallelized full sum Verlet trajectory integrator
...
TEST_CASE( "Test full sum verlet integrator", "[ParticleSimulation][FullSumVerletIntegrator][trajectory integration]") {
    ...
    SECTION("Full Sum Verlet integrator should be working with deferred particle addition") {

        // bare integrator without time step or other actions function
        Integration::FullSumVerletIntegrator verletIntegrator(accelerationFct);
    ...
    SECTION("Tests with particle lists"){
        ...
        SECTION( "Full Sum Verlet integrator should be able to integrate correctly non reactive particles with ToB") {
        ...
        SECTION( "Full Sum Verlet integrator should be able to integrate correctly particles born at start") {
